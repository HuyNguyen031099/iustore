...
urlpatterns = [
    ...
    path('product/up-shelf/<product_id>', product.showUpShelfForm, name = 'up-shelf-form'),
    path('product/up-shelf', product.upShelf, name='up-shelf'),
    path('product/edit-product/<product_id>', product.showEditProductForm, name = 'show-edit-product'),
    path('product/edit-product/edit/<product_id>', product.editProduct, name = 'edit-product'),
    path('product/delete-product/<product_id>', product.deleteProduct, name = 'delete-product'),
    # address api
